# Todo Exercise Client

A web application that allows users to manage their tasks and to-do lists. This is the client-side code for the application.
...
![Screenshot of the application](images/app_image.png)
